...
from communication.urls import communication_urlpatterns
...
] + content_urlpatterns + ai_urlpatterns + wallet_urlpatterns + channel_urlpatterns + publish_urlpatterns + report_urlpatterns + communication_urlpatterns
